  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="relative w-full h-[200px] md:h-[500px]">
        ...
        <Image src="/palika.jpg" alt="Mahanagarpalika" layout="fill" objectFit="cover" className="opacity-90"/>
      ...
      <div className="max-w-6xl mx-auto px-6 py-4">
        <div className="flex-col md:flex-row items-center md:space-x-8">
        <h1 className="text-orange-500 font-bold text-5xl italic text-center">ABOUT US</h1>

          <div>
            {/* <h2 className="text-3xl md:text-4xl font-bold text-orange-500 text-center">About Us</h2> */}
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        We started with a clear vision:<span className="font-bold">To bridge the gap between customers and local businesses
        in Navi Mumbai.</span> 
      ...
      <div className="bg-green-500 text-white text-center py-12 px-6 ">
        ...
        <Button className="mt-6 px-6 py-3 bg-white text-green-600 shadow-md hover:bg-gray-100 ">
          Get Started
        </Button>
