      ...
      <div className="md:hidden">
        {enquiries.map((enq, i) => (
          <div key={enq.enquiry_id} className="mb-4 p-4 bg-white rounded-lg shadow-md">
            ...
            <h3 className="text-lg font-semibold text-gray-800">{enq.business_name}</h3>
            <p className="text-sm text-gray-600 mt-1">User: {enq.user_name}</p>
            <p className="text-sm text-gray-600 mt-1">Email: {enq.user_email}</p>
